...
void CanFilterSetup(void)
{
    ...
    CAN_filter0.FilterIdHigh = (uint16_t) (0 << 5);
    CAN_filter0.FilterMaskIdHigh = (uint16_t) (0 << 5);

    CAN_filter0.FilterIdLow = (uint16_t) (0 << 5);
    CAN_filter0.FilterMaskIdLow = (uint16_t) (0 << 5);
